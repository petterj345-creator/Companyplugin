...
- **License system** — admins define license types via an in-game GUI. Each license type can have **multiple job templates**; the license rotates between them, giving variety. Each license type also has a **required company level** — companies below that level can't buy it. Companies buy licenses with company funds.
